  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="nav-link scrollto active" href="{{ url('/employee') }}">Home</a></li>
          <li><a class="nav-link scrollto" href="{{ url('/employee') }}">Employee Managment</a></li>
          <li><a class="nav-link scrollto" href="{{ url('/stat') }}">Statistics</a></li>
